...
class _HomePageState extends State<HomeChildPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final totalItemCount =
        ...
        (completedTodos.isNotEmpty ? completedTodos.length + 1 : 0);

    final items = [
      ...unCompletedTodos,
      if (completedTodos.isNotEmpty) "header",
      ...completedTodos,
    ];
          ...
          Align(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    AppConfigs.formatTimeNow(DateTime.now()),
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return TodoItem(
                            ...
                            time: AppConfigs.formatTimeOclock(
                              todo.time ?? DateTime.now().toString(),
                            ),
                            borderRadius: AppDimen.getBorderRadius(
                              currentIndex,
                              currentList,
                            ),
                            onTap: () {
                              homeProvider.toggleCompleted(
                                item.id,
                                item.isCompleted,
                              );
                            },
